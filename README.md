...
**Latest release**: July 1, 2017 &bull; version 1.1 &bull; [CHANGELOG](CHANGELOG.md)
...
- [GRDB Reference](http://groue.github.io/GRDB.swift/docs/1.1/index.html) (generated by [Jazzy](https://github.com/realm/jazzy))
...
1. [Download](https://github.com/groue/GRDB.swift/releases/tag/1.1) a copy of GRDB.swift, or clone its repository and make sure you use the latest tagged version with the `git checkout v1.1` command.
...
See [Configuration](http://groue.github.io/GRDB.swift/docs/1.1/Structs/Configuration.html) for more details.
...
See [Values](#values) for more information on supported arguments types (Bool, Int, String, Date, Swift enums, etc.), and [StatementArguments](http://groue.github.io/GRDB.swift/docs/1.1/Structs/StatementArguments.html) for a detailed documentation of SQLite arguments.
...
Values can be used as [statement arguments](http://groue.github.io/GRDB.swift/docs/1.1/Structs/StatementArguments.html):
...
Row adapters are values that adopt the [RowAdapter](http://groue.github.io/GRDB.swift/docs/1.1/Protocols/RowAdapter.html) protocol. You can implement your own custom adapters ([**:fire: EXPERIMENTAL**](#what-are-experimental-features)), or use one of the four built-in adapters:
...
- `sqlite3_busy_handler`, `sqlite3_busy_timeout`: see [Configuration.busyMode](http://groue.github.io/GRDB.swift/docs/1.1/Structs/Configuration.html)
- `sqlite3_changes`, `sqlite3_total_changes`: see [Database.changesCount and Database.totalChangesCount](http://groue.github.io/GRDB.swift/docs/1.1/Classes/Database.html)
...
- `sqlite3_sql`: see [Statement.sql](http://groue.github.io/GRDB.swift/docs/1.1/Classes/Statement.html)
- `sqlite3_trace`: see [Configuration.trace](http://groue.github.io/GRDB.swift/docs/1.1/Structs/Configuration.html)
- `sqlite3_wal_checkpoint_v2`: see [DatabasePool.checkpoint](http://groue.github.io/GRDB.swift/docs/1.1/Classes/DatabasePool.html)
...
See [fetching methods](#fetching-methods) for information about the `fetchCursor`, `fetchAll` and `fetchOne` methods. See [StatementArguments](http://groue.github.io/GRDB.swift/docs/1.1/Structs/StatementArguments.html) for more information about the query arguments.
...
Raw SQL snippets are also accepted, with eventual [arguments](http://groue.github.io/GRDB.swift/docs/1.1/Structs/StatementArguments.html):
...
- [SQLRequest](http://groue.github.io/GRDB.swift/docs/1.1/Structs/SQLRequest.html): a Request built from raw SQL
- [AnyRequest](http://groue.github.io/GRDB.swift/docs/1.1/Structs/AnyRequest.html): a type-erased Request
- [AnyTypedRequest](http://groue.github.io/GRDB.swift/docs/1.1/Structs/AnyTypedRequest.html): a type-erased TypedRequest
...
FTS3Pattern are regular [values](#values). You can use them as query [arguments](http://groue.github.io/GRDB.swift/docs/1.1/Structs/StatementArguments.html):
...
FTS5Pattern are regular [values](#values). You can use them as query [arguments](http://groue.github.io/GRDB.swift/docs/1.1/Structs/StatementArguments.html):
...
To avoid those problems, **never embed raw values in your SQL queries**. The only correct technique is to provide [arguments](http://groue.github.io/GRDB.swift/docs/1.1/Structs/StatementArguments.html) to your SQL queries:
...
Both DatabaseQueue and DatabasePool adopt the [DatabaseReader](http://groue.github.io/GRDB.swift/docs/1.1/Protocols/DatabaseReader.html) and [DatabaseWriter](http://groue.github.io/GRDB.swift/docs/1.1/Protocols/DatabaseWriter.html) protocols.
...
- Prepare to setup a [busy handler](https://www.sqlite.org/c3ref/busy_handler.html) with [Configuration.busyMode](http://groue.github.io/GRDB.swift/docs/1.1/Structs/Configuration.html)
...
There is an exception, though: *experimental features*, marked with the "**:fire: EXPERIMENTAL**" badge. Those are features that are too young, or lack user feedback. They are not stabilized yet.
