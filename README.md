...
See [Values](#values) for more information on supported arguments types (Bool, Int, String, Date, Swift enums, etc.), and [StatementArguments](http://groue.github.io/GRDB.swift/docs/0.110.0/Structs/StatementArguments.html) for a detailed documentation of SQLite arguments.
...
- [Request](http://groue.github.io/GRDB.swift/docs/0.110.0/Protocols/Request.html): the protocol for all requests
- [TypedRequest](http://groue.github.io/GRDB.swift/docs/0.110.0/Protocols/TypedRequest.html): the protocol for all typed requests
- [SQLRequest](http://groue.github.io/GRDB.swift/docs/0.110.0/Structs/SQLRequest.html): a Request built from raw SQL
- [AnyRequest](http://groue.github.io/GRDB.swift/docs/0.110.0/Structs/AnyRequest.html): a type-erased Request
- [AnyTypedRequest](http://groue.github.io/GRDB.swift/docs/0.110.0/Structs/AnyTypedRequest.html): a type-erased TypedRequest
...
FTS3Pattern are regular [values](#values). You can use them as query [arguments](http://groue.github.io/GRDB.swift/docs/0.110.0/Structs/StatementArguments.html):
...
FTS5Pattern are regular [values](#values). You can use them as query [arguments](http://groue.github.io/GRDB.swift/docs/0.110.0/Structs/StatementArguments.html):
...
To avoid those problems, **never embed raw values in your SQL queries**. The only correct technique is to provide [arguments](http://groue.github.io/GRDB.swift/docs/0.110.0/Structs/StatementArguments.html) to your SQL queries:
...
Both DatabaseQueue and DatabasePool adopt the [DatabaseReader](http://groue.github.io/GRDB.swift/docs/0.110.0/Protocols/DatabaseReader.html) and [DatabaseWriter](http://groue.github.io/GRDB.swift/docs/0.110.0/Protocols/DatabaseWriter.html) protocols.
...
- The definition of "current state" in DatabaseWriter.readFromCurrentState is [delicate](http://groue.github.io/GRDB.swift/docs/0.110.0/Protocols/DatabaseWriter.html#/s:FP4GRDB14DatabaseWriter20readFromCurrentStateFzFCS_8DatabaseT_T_).
...
- Prepare to setup a [busy handler](https://www.sqlite.org/c3ref/busy_handler.html) with [Configuration.busyMode](http://groue.github.io/GRDB.swift/docs/0.110.0/Structs/Configuration.html)
