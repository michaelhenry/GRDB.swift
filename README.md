...
**Latest release**: April 11, 2017 &bull; version 0.106.0 &bull; [CHANGELOG](CHANGELOG.md)
...
- [GRDB Reference](http://groue.github.io/GRDB.swift/docs/0.106.0/index.html) (generated by [Jazzy](https://github.com/realm/jazzy))
...
1. [Download](https://github.com/groue/GRDB.swift/releases/tag/v0.106.0) a copy of GRDB.swift, or clone its repository and make sure you use the latest tagged version with the `git checkout v0.106.0` command.
...
See [Configuration](http://groue.github.io/GRDB.swift/docs/0.106.0/Structs/Configuration.html) for more details.
...
See [Values](#values) for more information on supported arguments types (Bool, Int, String, Date, Swift enums, etc.), and [StatementArguments](http://groue.github.io/GRDB.swift/docs/0.106.0/Structs/StatementArguments.html) for a detailed documentation of SQLite arguments.
...
Values can be used as [statement arguments](http://groue.github.io/GRDB.swift/docs/0.106.0/Structs/StatementArguments.html):
...
Row adapters are values that adopt the [RowAdapter](http://groue.github.io/GRDB.swift/docs/0.106.0/Protocols/RowAdapter.html) protocol. You can implement your own custom adapters, or use one of the four built-in adapters:
...
- `sqlite3_busy_handler`, `sqlite3_busy_timeout`: see [Configuration.busyMode](http://groue.github.io/GRDB.swift/docs/0.106.0/Structs/Configuration.html)
- `sqlite3_changes`, `sqlite3_total_changes`: see [Database.changesCount and Database.totalChangesCount](http://groue.github.io/GRDB.swift/docs/0.106.0/Classes/Database.html)
...
- `sqlite3_sql`: see [Statement.sql](http://groue.github.io/GRDB.swift/docs/0.106.0/Classes/Statement.html)
- `sqlite3_trace`: see [Configuration.trace](http://groue.github.io/GRDB.swift/docs/0.106.0/Structs/Configuration.html)
- `sqlite3_wal_checkpoint_v2`: see [DatabasePool.checkpoint](http://groue.github.io/GRDB.swift/docs/0.106.0/Classes/DatabasePool.html)
...
See [fetching methods](#fetching-methods) for information about the `fetchCursor`, `fetchAll` and `fetchOne` methods. See [StatementArguments](http://groue.github.io/GRDB.swift/docs/0.106.0/Structs/StatementArguments.html) for more information about the query arguments.
...
Raw SQL snippets are also accepted, with eventual [arguments](http://groue.github.io/GRDB.swift/docs/0.106.0/Structs/StatementArguments.html):
...
- [Request](http://groue.github.io/GRDB.swift/docs/0.106.0/Protocols/Request.html): the protocol for all requests
- [TypedRequest](http://groue.github.io/GRDB.swift/docs/0.106.0/Protocols/TypedRequest.html): the protocol for all typed requests
- [SQLRequest](http://groue.github.io/GRDB.swift/docs/0.106.0/Structs/SQLRequest.html): a Request built from raw SQL
- [AnyRequest](http://groue.github.io/GRDB.swift/docs/0.106.0/Structs/AnyRequest.html): a type-erased Request
- [AnyTypedRequest](http://groue.github.io/GRDB.swift/docs/0.106.0/Structs/AnyTypedRequest.html): a type-erased TypedRequest
...
FTS3Pattern are regular [values](#values). You can use them as query [arguments](http://groue.github.io/GRDB.swift/docs/0.106.0/Structs/StatementArguments.html):
...
FTS5Pattern are regular [values](#values). You can use them as query [arguments](http://groue.github.io/GRDB.swift/docs/0.106.0/Structs/StatementArguments.html):
...
To avoid those problems, **never embed raw values in your SQL queries**. The only correct technique is to provide [arguments](http://groue.github.io/GRDB.swift/docs/0.106.0/Structs/StatementArguments.html) to your SQL queries:
...
Both DatabaseQueue and DatabasePool adopt the [DatabaseReader](http://groue.github.io/GRDB.swift/docs/0.106.0/Protocols/DatabaseReader.html) and [DatabaseWriter](http://groue.github.io/GRDB.swift/docs/0.106.0/Protocols/DatabaseWriter.html) protocols.
...
- The definition of "current state" in DatabaseWriter.readFromCurrentState is [delicate](http://groue.github.io/GRDB.swift/docs/0.106.0/Protocols/DatabaseWriter.html#/s:FP4GRDB14DatabaseWriter20readFromCurrentStateFzFCS_8DatabaseT_T_).
...
- Prepare to setup a [busy handler](https://www.sqlite.org/c3ref/busy_handler.html) with [Configuration.busyMode](http://groue.github.io/GRDB.swift/docs/0.106.0/Structs/Configuration.html)
