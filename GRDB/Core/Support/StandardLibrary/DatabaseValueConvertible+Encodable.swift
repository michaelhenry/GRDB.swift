private struct DatabaseValueEncodingContainer : SingleValueEncodingContainer {
    ...
    func encodeNil() throws { encode(.null) }
    ...
    /// - precondition: May not be called after a previous `self.encode(_:)` call.
    func encode(_ value: Bool) throws { encode(value.databaseValue) }
    func encode(_ value: Int) throws { encode(value.databaseValue) }
    func encode(_ value: Int8) throws { encode(value.databaseValue) }
    func encode(_ value: Int16) throws { encode(value.databaseValue) }
    func encode(_ value: Int32) throws { encode(value.databaseValue) }
    func encode(_ value: Int64) throws { encode(value.databaseValue) }
    func encode(_ value: UInt) throws { encode(value.databaseValue) }
    func encode(_ value: UInt8) throws { encode(value.databaseValue) }
    func encode(_ value: UInt16) throws { encode(value.databaseValue) }
    func encode(_ value: UInt32) throws { encode(value.databaseValue) }
    func encode(_ value: UInt64) throws { encode(value.databaseValue) }
    func encode(_ value: Float) throws { encode(value.databaseValue) }
    func encode(_ value: Double) throws { encode(value.databaseValue) }
    func encode(_ value: String) throws { encode(value.databaseValue) }
