...
public func == <Left, Right, Annotation>(lhs: HasManyAnnotation<Left, Right, Annotation>, rhs: Annotation?) -> HasManyAnnotationPredicate<Left, Right, Annotation> where Left: TableMapping, Right: TableMapping, Annotation: SQLExpressible {
